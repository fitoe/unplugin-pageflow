...
await access('dist/runtime/inspectors.js')
await access('dist/runtime/inspectors.d.ts')
...
assert.equal(packageManifest.exports['./inspectors'].import, './dist/runtime/inspectors.js')
